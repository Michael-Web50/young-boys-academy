import { a as useGrantsStore, dn as isRecord, l as useProjectStore, nn as useSchema, r as useDocumentPreviewStore, s as useKeyValueStore, u as useRenderingContextStore } from "./datastores-QCSg1Xje.js";
...
import { c as useWorkspace, i as useClient, n as DEFAULT_STUDIO_CLIENT_OPTIONS, o as useSource } from "./studioClient-BHPpGoe6.js";
import { _ as SanityDefaultPreview, s as useValuePreview, t as useActiveReleases, tt as useDocumentVersions } from "./useActiveReleases-DdQHoUIU.js";
import { C as isNonNullable, l as getPublishedId, x as removeDupes } from "./draftUtils-D3HJGQaW.js";
import { n as useCurrentUser } from "./LoadingBlock-DvIZeBYm.js";
import { u as EMPTY_ARRAY } from "./DateInputs-DuTFy9S0.js";
import { c as truncateString } from "./ReleaseAvatar-DGSHma7q.js";
...
import { a as useSearchMaxFieldDepth, n as PreviewCard, o as createSearch, u as supportsTouch } from "./Details-DFnxl0IZ.js";
...
import { Fragment, isValidElement, memo, useContext, useDeferredValue, useEffect, useId, useReducer, useRef, useState } from "react";
import { EMPTY, Subject, concat, iif, map, merge, of, startWith, timer } from "rxjs";
...
import { Badge, Button, Card, Container, Flex, Inline, Portal, Stack, Text, TextInput, rem, studioTheme, useClickOutsideEvent, useGlobalKeyDown, useLayer, useMediaIndex } from "@sanity/ui";
import { css, keyframes, styled } from "styled-components";
import { Box as Box$1 } from "ui5";
import { ErrorOutlineIcon } from "@sanity/icons/ErrorOutline";
import { WarningOutlineIcon } from "@sanity/icons/WarningOutline";
import { useTelemetry } from "@sanity/telemetry/react";
import { catchError as catchError$1, debounce as debounce$1, distinctUntilChanged as distinctUntilChanged$1, filter as filter$1, map as map$1, scan as scan$1, startWith as startWith$1, switchMap as switchMap$1, tap as tap$1 } from "rxjs/operators";
import { useObservable, useObservableEvent, useSyncObservable } from "react-rx";
...
function useProjectOrganizationId() {
	...
	return $[0] === projectStore ? t0 = $[1] : (t0 = projectStore.getOrganizationId().pipe(map(_temp$8), startWith({
		value: null,
		loading: !0
	})), $[0] = projectStore, $[1] = t0), useObservable(t0, INITIAL_STATE);
}
function _temp$8(res) {
	return {
		value: res,
		loading: !1
	};
...
function SearchResultItemPreview(t0) {
	...
	bb0: {
		...
		let t9;
		$[18] !== t6 || $[19] !== t7 || $[20] !== t8 ? (t9 = /* @__PURE__ */ jsxs(Flex, {
			align: "center",
			gap: 3,
			children: [
				t6,
...
function useSearch(t0) {
	let $ = c(16), { allowEmptyQueries, initialState, onComplete, onError, onStart, schema } = t0, [searchState, setSearchState] = useState(initialState), client = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), maxFieldDepth = useSearchMaxFieldDepth(), { strategy } = useWorkspace().search, t1;
	...
	let search = t1, t2;
	$[5] !== allowEmptyQueries || $[6] !== onComplete || $[7] !== onError || $[8] !== onStart || $[9] !== search ? (t2 = (inputValue$) => inputValue$.pipe(filter$1(nonNullable), map$1(sanitizeRequest), distinctUntilChanged$1(isEqual), debounce$1(_temp$7), tap$1(onStart), switchMap$1((request_0) => concat(of({
		...INITIAL_SEARCH_STATE,
		loading: !0,
		options: request_0.options,
		terms: request_0.terms
	}), iif(() => hasSearchableTerms({
		allowEmptyQueries,
		terms: request_0.terms
	}), search(request_0.terms, request_0.options).pipe(tap$1((t3) => {
		let { hits, nextCursor } = t3;
		return onComplete?.({
			hits,
			nextCursor
		});
	}), catchError$1((error) => (onError?.(error), of({
		...INITIAL_SEARCH_STATE,
		error,
		loading: !1,
		options: request_0.options,
		terms: request_0.terms
	})))), of(EMPTY).pipe(tap$1(() => onComplete?.({
		hits: [],
		nextCursor: void 0
	})))), of({ loading: !1 }))), scan$1(_temp2$2, INITIAL_SEARCH_STATE), tap$1(setSearchState)), $[5] = allowEmptyQueries, $[6] = onComplete, $[7] = onError, $[8] = onStart, $[9] = search, $[10] = t2) : t2 = $[10];
	let handleQueryChange = useObservableEvent(t2), t3;
	$[11] === handleQueryChange ? t3 = $[12] : (t3 = (searchRequest) => handleQueryChange(searchRequest), $[11] = handleQueryChange, $[12] = t3);
	let handleSearch = t3, t4;
	return $[13] !== handleSearch || $[14] !== searchState ? (t4 = {
		handleSearch,
		searchState
	}, $[13] = handleSearch, $[14] = searchState, $[15] = t4) : t4 = $[15], t4;
}
function _temp2$2(prevState, nextState) {
	return {
		...prevState,
		...nextState
	};
}
function _temp$7(request) {
	return timer(request?.debounceTime || 300);
}
/**
...
function FilterPopoverWrapper(t0) {
	...
	let t5;
	$[7] === children ? t5 = $[8] : (t5 = /* @__PURE__ */ jsx(Flex, { children }), $[7] = children, $[8] = t5);
	let t6;
...
const SearchHeaderBox = styled(Box$1).withConfig({
	...
	componentId: "sc-74orri-0"
})`border-bottom:1px solid ${({ theme }) => theme.sanity.color.base.border};flex-shrink:0;`, SearchHeaderContentFlex = styled(Flex).withConfig({
	displayName: "SearchHeaderContentFlex",
	componentId: "sc-74orri-1"
...
function AddFilterPopoverContent(t0) {
	...
	let t13;
	$[33] !== t11 || $[34] !== t12 ? (t13 = /* @__PURE__ */ jsxs(Flex, { children: [t11, t12] }), $[33] = t11, $[34] = t12, $[35] = t13) : t13 = $[35];
	let t14;
	return $[36] !== t10 || $[37] !== t13 ? (t14 = /* @__PURE__ */ jsxs(Flex, {
		direction: "column",
...
function DocumentTypesPopoverContent() {
	...
	let getItemKey = t5, renderItem = _temp$6, t6;
	...
	let t12;
	$[26] !== t10 || $[27] !== t11 ? (t12 = /* @__PURE__ */ jsxs(Flex, { children: [t10, t11] }), $[26] = t10, $[27] = t11, $[28] = t12) : t12 = $[28];
	let t13;
	...
	let t14;
	return $[33] !== t12 || $[34] !== t13 || $[35] !== t9 ? (t14 = /* @__PURE__ */ jsxs(Flex, {
		direction: "column",
...
const CustomBox = styled(Box$1).withConfig({
	...
	componentId: "sc-me5coy-0"
})`flex-shrink:${({ $flexShrink = 0 }) => $flexShrink};`;
function FilterLabel(t0) {
	let $ = c(29), { filter, fontSize: t1, showContent: t2 } = t0, fontSize = t1 === void 0 ? 1 : t1, showContent = t2 === void 0 || t2, { t } = useTranslation(), { state: t3 } = useSearchState(), { definitions, fullscreen } = t3, t4;
	...
	let operator = t4, ButtonValue = operator?.buttonValueComponent, filterValue = filter.value, t5;
	$[3] !== filter || $[4] !== fontSize || $[5] !== fullscreen ? (t5 = () => /* @__PURE__ */ jsx(CustomBox, {
		$flexShrink: +!!fullscreen,
		children: /* @__PURE__ */ jsx(TextWithTone, {
			tone: "default",
			size: fontSize,
			textOverflow: "ellipsis",
			weight: "medium",
			children: /* @__PURE__ */ jsx(FilterTitle, {
				filter,
				maxLength: fullscreen ? 25 : 40
			})
		})
	}), $[3] = filter, $[4] = fontSize, $[5] = fullscreen, $[6] = t5) : t5 = $[6];
	let t6;
	$[7] !== fontSize || $[8] !== showContent ? (t6 = (t7) => {
		let { children } = t7;
		return showContent ? /* @__PURE__ */ jsx(CustomBox, {
			$flexShrink: 0,
			children: /* @__PURE__ */ jsx(TextWithTone, {
				tone: "default",
				size: fontSize,
	...
	}, $[7] = fontSize, $[8] = showContent, $[9] = t6) : t6 = $[9];
	let t7;
	$[10] !== ButtonValue || $[11] !== filterValue || $[12] !== fontSize || $[13] !== showContent ? (t7 = (t8) => {
		let { children: children_0 } = t8;
		return showContent ? /* @__PURE__ */ jsx(CustomBox, {
			$flexShrink: 1,
			children: /* @__PURE__ */ jsx(TextWithTone, {
				tone: "default",
				...
				textOverflow: "ellipsis",
				weight: "medium",
				children: ButtonValue ? /* @__PURE__ */ jsx(ButtonValue, { value: filterValue }) : children_0
			})
		}) : null;
	}, $[10] = ButtonValue, $[11] = filterValue, $[12] = fontSize, $[13] = showContent, $[14] = t7) : t7 = $[14];
	let t8;
	$[15] !== t5 || $[16] !== t6 || $[17] !== t7 ? (t8 = {
		Field: t5,
		Operator: t6,
		Value: t7
	}, $[15] = t5, $[16] = t6, $[17] = t7, $[18] = t8) : t8 = $[18];
	let components = t8;
	if (operator?.descriptionKey || console.warn("Missing `descriptionKey` for operator `%s`", filter.operatorType), !showContent || !operator?.descriptionKey) {
		let Field = components.Field, t9;
		return $[19] === Field ? t9 = $[20] : (t9 = /* @__PURE__ */ jsx(Flex, {
			align: "center",
			gap: 1,
			children: /* @__PURE__ */ jsx(Field, {})
		}), $[19] = Field, $[20] = t9), t9;
	}
	let t9 = operator?.descriptionKey, t10;
	$[21] !== filter || $[22] !== t ? (t10 = getFilterValues(filter, t), $[21] = filter, $[22] = t, $[23] = t10) : t10 = $[23];
	let t11;
	return $[24] !== components || $[25] !== t || $[26] !== t10 || $[27] !== t9 ? (t11 = /* @__PURE__ */ jsx(Flex, {
		align: "center",
		gap: 1,
	...
	}), $[24] = components, $[25] = t, $[26] = t10, $[27] = t9, $[28] = t11) : t11 = $[28], t11;
}
...
function FilterError(props) {
	...
	let t5;
	$[9] !== t2 || $[10] !== t4 ? (t5 = /* @__PURE__ */ jsxs(Flex, {
		align: "flex-start",
		gap: 3,
...
function FilterForm(t0) {
	...
	let t12;
	$[30] !== t10 || $[31] !== t11 ? (t12 = /* @__PURE__ */ jsxs(Flex, {
		align: "flex-start",
		gap: 3,
...
const ContainerFlex = styled(Flex).withConfig({
	displayName: "ContainerFlex",
	componentId: "sc-zuf3fc-0"
...
function Filters(t0) {
	...
	let t14;
	$[21] !== t11 || $[22] !== t12 || $[23] !== t13 ? (t14 = /* @__PURE__ */ jsxs(Flex, {
		flex: 1,
		gap: 2,
		wrap: "wrap",
		children: [
	...
	$[25] !== t14 || $[26] !== t15 ? (t16 = /* @__PURE__ */ jsxs(Flex, {
		align: "flex-start",
		gap: 3,
		justify: "space-between",
		padding: 2,
	...
	let t17;
	$[28] !== clearFiltersButton || $[29] !== clearFiltersButtonVisible || $[30] !== fullscreen ? (t17 = fullscreen && /* @__PURE__ */ jsxs(Flex, {
		justify: "space-between",
		paddingBottom: 2,
		paddingX: 2,
...
function useStoredSearch() {
	...
	}), map$1(_temp$5)), optimisticWrites$).pipe(startWith$1(defaultValue)), $[3] = keyValueStore, $[4] = keyValueStoreKey, $[5] = t2) : t2 = $[5];
...
function useRecentSearchesStore() {
	...
	return $[11] !== fieldDefinitions || $[12] !== filterDefinitions || $[13] !== operatorDefinitions || $[14] !== schema || $[15] !== setStoredSearch || $[16] !== storedSearch ? (t5 = {
		addSearch: (searchTerm, searchFilters) => {
			let validStoredFilters = (searchFilters || []).map(_temp$4).filter((filter_0) => validateFilter({
				fieldDefinitions,
				filter: filter_0,
				filterDefinitions,
				operatorDefinitions
...
function Instructions() {
	...
	$[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = { ControlsIcon: _temp$3 }, $[0] = t0) : t0 = $[0];
	let t1;
	return $[1] === t ? t1 = $[2] : (t1 = /* @__PURE__ */ jsx(Flex, {
		align: "center",
		direction: "column",
		gap: 4,
		paddingX: 4,
...
function _temp$3() {
	return /* @__PURE__ */ jsx(ControlsIcon, { style: { padding: "0 0.25rem" } }, 0);
}
...
const RecentSearchItemButton = styled(Button).withConfig({
	...
	componentId: "sc-egw4a3-1"
})`flex-shrink:3;`, SearchItemQueryFlex = styled(Flex).withConfig({
	displayName: "SearchItemQueryFlex",
	componentId: "sc-egw4a3-2"
})`flex-shrink:2;`, CloseButtonDiv = styled.div.withConfig({
	displayName: "CloseButtonDiv",
	componentId: "sc-egw4a3-3"
...
function RecentSearchItem(t0) {
	...
	let t8;
	$[21] !== t5 || $[22] !== t6 || $[23] !== t7 ? (t8 = /* @__PURE__ */ jsxs(Flex, {
		align: "stretch",
		flex: 1,
		gap: 2,
		justify: "flex-start",
	...
	let t9;
	$[25] === Symbol.for("react.memo_cache_sentinel") ? (t9 = /* @__PURE__ */ jsx(Flex, {
		padding: 2,
		children: /* @__PURE__ */ jsx(Text, {
			size: 1,
	...
	let t10;
	$[26] === handleDelete ? t10 = $[27] : (t10 = /* @__PURE__ */ jsx(Flex, {
		align: "center",
	...
	let t11;
	$[28] !== t10 || $[29] !== t8 ? (t11 = /* @__PURE__ */ jsxs(Flex, {
		align: "stretch",
		children: [
			t4,
			t8,
...
function SearchError() {
	...
	let t5;
	return $[9] !== t2 || $[10] !== t4 ? (t5 = /* @__PURE__ */ jsxs(Flex, {
		align: "center",
		"aria-live": "assertive",
		direction: "column",
		flex: 1,
...
}), SortMenuContentFlex = styled(Flex).withConfig({
	displayName: "SortMenuContentFlex",
	componentId: "sc-081r9v-0"
})`box-sizing:border-box;`;
...
function SortMenu() {
	let $ = c(48), { t } = useTranslation(), { strategy: searchStrategy } = useWorkspace().search, { state: t0 } = useSearchState(), { ordering } = t0, menuButtonId = useId(), t1;
	...
	let menuOrderings = t4, T0, T1, T2, T3, t10, t11, t12, t5, t6, t7, t8, t9;
	if ($[10] !== menuOrderings || $[11] !== ordering || $[12] !== t) {
		...
		bb0: {
			...
			T3 = Card, t11 = !0, T2 = SortMenuContentFlex, t8 = "center", t9 = 1, t10 = 2, T1 = MenuButton$1, T0 = Button$1, t5 = "bleed", t6 = SortIcon, t7 = t(currentMenuItem.titleKey);
		}
		$[10] = menuOrderings, $[11] = ordering, $[12] = t, $[13] = T0, $[14] = T1, $[15] = T2, $[16] = T3, $[17] = t10, $[18] = t11, $[19] = t12, $[20] = t5, $[21] = t6, $[22] = t7, $[23] = t8, $[24] = t9;
	} else T0 = $[13], T1 = $[14], T2 = $[15], T3 = $[16], t10 = $[17], t11 = $[18], t12 = $[19], t5 = $[20], t6 = $[21], t7 = $[22], t8 = $[23], t9 = $[24];
	if (t12 !== Symbol.for("react.early_return_sentinel")) return t12;
	let t13;
	$[25] !== T0 || $[26] !== t5 || $[27] !== t6 || $[28] !== t7 ? (t13 = /* @__PURE__ */ jsx(T0, {
		mode: t5,
		icon: t6,
		text: t7
	}), $[25] = T0, $[26] = t5, $[27] = t6, $[28] = t7, $[29] = t13) : t13 = $[29];
	let t14 = menuButtonId || "", t15;
	$[30] === menuOrderings ? t15 = $[31] : (t15 = /* @__PURE__ */ jsx(Menu, { children: menuOrderings.map(_temp$1) }), $[30] = menuOrderings, $[31] = t15);
	let t16;
	...
	let t17;
	$[33] !== T1 || $[34] !== t13 || $[35] !== t14 || $[36] !== t15 ? (t17 = /* @__PURE__ */ jsx(T1, {
		button: t13,
		id: t14,
		menu: t15,
		popover: t16
	}), $[33] = T1, $[34] = t13, $[35] = t14, $[36] = t15, $[37] = t17) : t17 = $[37];
	let t18;
	$[38] !== T2 || $[39] !== t10 || $[40] !== t17 || $[41] !== t8 || $[42] !== t9 ? (t18 = /* @__PURE__ */ jsx(T2, {
		align: t8,
		flex: t9,
		padding: t10,
		children: t17
	}), $[38] = T2, $[39] = t10, $[40] = t17, $[41] = t8, $[42] = t9, $[43] = t18) : t18 = $[43];
	let t19;
	return $[44] !== T3 || $[45] !== t11 || $[46] !== t18 ? (t19 = /* @__PURE__ */ jsx(T3, {
		borderBottom: t11,
		children: t18
	}), $[44] = T3, $[45] = t11, $[46] = t18, $[47] = t19) : t19 = $[47], t19;
}
...
const SearchResultsInnerFlex = styled(Flex).withConfig({
	displayName: "SearchResultsInnerFlex",
	componentId: "sc-g6d922-0"
...
function SearchResults(t0) {
	...
	let t11;
	$[31] !== t10 || $[32] !== t6 ? (t11 = /* @__PURE__ */ jsxs(Flex, {
		direction: "column",
		height: "fill",
		children: [t6, t10]
	}), $[31] = t10, $[32] = t6, $[33] = t11) : t11 = $[33];
	let t12;
	return $[34] !== t11 || $[35] !== t5 ? (t12 = /* @__PURE__ */ jsx(Flex, { children: /* @__PURE__ */ jsx(Card, {
		borderTop: t5,
		flex: 1,
		children: t11
...
//# sourceMappingURL=SearchProvider-BTSYtnUB.js.map