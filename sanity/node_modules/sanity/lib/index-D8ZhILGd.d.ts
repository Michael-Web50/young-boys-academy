import { Ar as DocumentPreviewStore, As as LocaleSource, Au as DocumentFieldAction, Bl as TargetPerspective, Br as DraftsModelDocumentAvailability, Bs as FormBuilderMarkersComponent, Bu as DocumentFieldActionsResolverContext, C as ProjectGrants, Ca as ItemDiff$1, Cc as RenderFieldCallback, Cn as ConfigContext$1, Dc as RenderPreviewCallbackProps, Ds as LocaleResourceBundle, Ea as ObjectDiff$1, Ec as RenderPreviewCallback, Eu as PresenceLocation, Fa as StudioLocaleResourceKeys, Fl as PerspectiveContextValue, Fo as StudioTheme, Fs as TFunction$2, Fu as DocumentFieldActionNode, Go as SearchOperatorDefinitionDictionary, Ha as DocumentVersionEventType, Hc as NodeChronologyProps, Il as PerspectiveStack, Io as StudioThemeColorSchemeKey, Is as ArrayInputFunctionsProps, Ji as DocumentVersionEvent, Jn as Plugin, Jr as PreviewPath, Kc as ObjectFormNode, Ki as CommitError, Kt as StateTree, Li as SelectionState, Ll as ReleaseId, Lo as InitialValueTemplateItem, Lr as DocumentAvailability, Ls as FormBuilderCustomMarkersComponent, Ml as UploaderResolver, Mo as StoreRequestErrorHandler, Na as FieldValueError, Ni as HistoryStore, Oa as StringDiff$1, Pl as PerspectiveBundle, Qc as ArrayOfPrimitivesItemMember, Qr as ObserveDocumentAPIConfig, Ri as TimelineController, Rl as ReleasesNavMenuItemPropsGetter, Ro as Template, Rs as FormBuilderFilterFieldFn, S as ProjectDatasetData, Sa as GroupChangeNode, Sc as RenderBlockCallback, Sn as Config, St as FormDocumentValue, T as ProjectStore, Tc as RenderItemCallback, Tr as ValidationStatus, Tu as GlobalPresence, Un as MissingConfigFile, Ut as FormState, Va as DocumentGroupEvent, Vl as SystemVariant, Vu as PatchEvent, Wa as EventsStore, Xc as ArrayOfObjectsItemMember, Xi as Pair, Xn as PreparedConfig, Xr as PreviewableType, Xu as FormPatchOrigin, Yn as PluginOptions, Ys as FieldCommentsProps, Yt as RelativeTimeOptions, Zc as ArrayOfObjectsMember, Zi as RemoteSnapshotVersionEvent, _l as ItemProps, _r as NavbarProps, _s as AuthConfig, _t as PatchChannel, aa as Annotation, ac as BooleanInputProps, ad as PreviewLayoutKey, bc as RenderArrayOfObjectsItemCallback, bi as DocumentActionProps, bl as PrimitiveItemProps, bo as DocumentPairTarget, br as ToolMenuProps, bs as LoginMethod, co as DocumentVariantType, cr as Workspace, da as ChangeTitlePath, dc as ObjectInputProps, di as DocumentActionComponent, ds as SearchFieldDefinitionDictionary, fa as Chunk, fr as WorkspaceSummary, ga as DiffComponentOptions, gu as FormNodePresence, ha as DiffComponent, hc as PortableTextInputProps, hr as LogoProps, il as ObjectMember, ir as SourceClientOptions, ka as StringDiffSegment, ki as OperationsAPI, lc as InputProps, li as GetHookCollectionStateProps, ll as FieldError, ma as Diff$1, mo as DocumentStoreExtraOptions, ms as AuthStore, mu as FormFieldGroup, nd as GeneralPreviewLayoutKey, nl as FieldSetMember, nr as SingleWorkspace, oa as AnnotationDetails, od as PreviewMediaDimensions, oi as DocumentBadgeComponent, pc as OnPathFocusPayload, ps as AuthState, ql as SystemBundle, qo as SearchFilterDefinitionDictionary, qu as FormPatch, rc as ArrayOfPrimitivesInputProps, rr as Source, sd as PreviewProps, sl as ArrayItemError, sr as Tool, tc as ArrayOfObjectsInputProps, tl as FieldMember, tr as SchemaPluginOptions, ua as ChangeNode, uc as NumberInputProps, uo as EditStateFor, vc as StringInputProps, vl as ObjectItem, wc as RenderInputCallback, wn as ConfigPropertyReducer, ws as LocaleDefinition, wu as DocumentPresence, x as ProjectData, xa as FromToIndex, xc as RenderArrayOfPrimitivesItemCallback, xo as IdPair, ya as FieldChangeNode, yc as RenderAnnotationCallback, yl as ObjectItemProps, ys as CookielessCompatibleLoginMethod } from "./validateDocument-7XErM0VG.js";
...
import { ArraySchemaType, AssetSource, BooleanSchemaType, ConditionalProperty, CrossDatasetType, CurrentUser, DeprecatedProperty, DocumentSystem, FieldGroup, File, FileAsset, FileSchemaType, FormNodeValidation, I18nTextRecord, Image, ImageAsset, ImageSchemaType, InitialValueProperty, InitialValueResolverContext, KeyedObject, NumberSchemaType, ObjectSchemaType, Path, PathSegment, PortableTextBlock, PrepareViewOptions, PreviewValue, Reference, ReferenceSchemaType, Role, SanityDocument, SanityDocumentLike, Schema, SchemaType, SchemaTypeDefinition, SearchStrategy, SlugSchemaType, SlugValue, SortOrdering, StrictVersionLayeringOptions, StringSchemaType, TextSchemaType, UploadState, User, ValidationMarker } from "@sanity/types";
import { AvatarPosition, AvatarProps, AvatarSize, AvatarStatus, BadgeProps, BadgeTone, Button, ButtonProps, ButtonTone, CardProps, HotkeysProps, Placement, ResponsiveWidthProps, Skeleton, TextProps, ThemeColorSchemeKey } from "@sanity/ui";
...
import { ClientConfig, ClientPerspective, HttpError, ReconnectEvent, ReleaseDocument, ReleaseDocument as ReleaseDocument$1, ReleaseType, RequestHandler, ResetEvent, SanityClient, SanityClient as SanityClient$1, SanityDocument as SanityDocument$1, SanityDocumentStub, SingleActionResult, StackablePerspective, WelcomeBackEvent, WelcomeEvent, isTimeoutError } from "@sanity/client";
...
import { IntentLinkProps, IntentParameters, RouterState, SearchParam } from "sanity/router";
...
declare namespace ImperativeToast {
 ...
 * @internal
 */
declare const FormContainer: import("styled-components/dist/types").IStyledComponentBase<"web", Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "style"> & {
  style?: import("react").CSSProperties | import("styled-components/dist/types").CSSPropertiesWithVars | undefined;
}> & string;
/**
 * @internal
...
export { getVariantPublishedSibling as $, useExcludedPerspective as $a, UpdateReadOnlyPlugin as $c, defineDocumentFieldAction as $d, RelativeTime as $f, SchedulesContextValue as $i, useDocumentChange as $l, CommentPath as $m, useColorSchemeOptions as $n, useDocumentOperationEvent as $o, CollapseMenuButton as $p, validation as $r, useTemplatePermissionsFromHookFactory as $s, isValidAnnouncementRole as $t, UserColor as $u, truncateString as A, ReleaseAvatar as Aa, MemberItemProps as Ac, useConfigContextFromSource as Ad, OperationSuccess as Af, ActiveWorkspaceMatcherContextValue as Ah, isAuthStore as Ai, GetFormValueProvider as Al, CommentsSelectedPathContextValue as Am, ToolLink as An, useTargetDocumentState as Ao, serializeError as Ap, useDocumentValuePermissions as Ar, ImageInputProps as As, useWorkspaces as At, FieldPreviewComponent as Au, CardinalityOneRelease as B, useUnstableObserveDocument as Ba, TelephoneInputProps as Bc, RequestFailureDiagnostics as Bd, ToastParams$1 as Bf, SingleDocReleaseProvider as Bi, FormFieldValidationInfo as Bl, useNavigateToCanvasDoc as Bm, SearchProvider as Bn, useNumberFormat as Bo, isReleaseDocument as Bp, useInitialValue as Br, defaultRenderInput as Bs, WorkspaceLoaderBoundary as Bt, ChangeResolverProps as Bu, isReleaseVersion as C, useIsReleaseActive as Ca, MemberFieldError as Cc, DocumentGroupInventory as Cd, getInitialValueStream as Cf, PermissionCheckResult as Ch, ConnectionStatus as Ci, HoveredFieldProvider as Cl, COMMENTS_INSPECTOR_NAME as Cm, LiveManifestRegisterProvider as Cn, useTimeAgo as Co, LoadingBlock as Cp, TimelineStore as Cr, isBooleanInputProps as Cs, useDocumentPreviewValues as Ct, DiffTooltipWithAnnotationsProps as Cu, useThrottledCallback as D, VersionInlineBadge as Da, ArrayOfPrimitivesItem as Dc, DivergenceNavigator as Dd, InitialValueState as Df, UpsellDialogViewed as Dh, RetryingStatus as Di, FieldActionsProvider as Dl, CommentInputProps as Dm, StudioManifest as Dn, getCreatableVariantTarget as Do, Hotkeys$1 as Dp, grantsPermissionOn as Dr, isStringInputProps as Ds, validateBasePaths as Dt, DiffInspectWrapperProps as Du, useUnique as E, useDocumentVersions as Ea, MemberItemError as Ec, DocumentGroupInventoryReferencePreviewLinkProps as Ed, InitialValueMsg as Ef, UpsellDialogUpgradeCtaClicked as Eh, ErrorStatus as Ei, FieldActionsResolver as El, CommentInputHandle as Em, ManifestWorkspaceInput as En, TargetDocumentState as Eo, InsufficientPermissionsMessageProps as Ep, createGrantsStore as Er, isObjectItemProps as Es, ValidateWorkspaceOptions as Et, DiffInspectWrapper as Eu, joinPath as F, getPreviewValueWithFallback as Fa, UrlInput as Fc, createWorkspaceFromConfig as Fd, UserAvatarProps as Ff, useAgentVersionDisplay as Fi, FormContainer as Fl, ConnectorContextValue as Fm, SearchDialog as Fn, DocumentField as Fo, DocumentVersionsStatusIndicator as Fp, useDocumentPairPermissionsFromHookFactory as Fr, FormProviderProps as Fs, getNamelessWorkspaceIdentifier as Ft, DiffCardProps as Fu, measureFirstMatch as G, PresenceScope as Ga, SlugInputProps as Gc, RequestErrorReportOptions as Gd, StatusButtonProps as Gf, SearchSort as Gi, FormFieldStatus as Gl, CommentContext as Gm, SearchHeader as Gn, GlobalCopyPasteElementHandler as Go, CommandListElementType as Gp, ErrorState as Gr, ReferenceInputOptions as Gs, UpsellDescriptionSerializer as Gt, useAnnotationColor as Gu, isCardinalityOneRelease as H, SanityDefaultPreviewProps as Ha, TagsArrayInputProps as Hc, createAuthStore as Hd, TextWithTone as Hf, createSearch as Hi, FormFieldValidationStatus as Hl, CommentsEnabledContextValue as Hm, SearchResultItemPreview as Hn, useManageFavorite as Ho, Delay as Hp, selectUpstreamVersion as Hr, defaultRenderPreview as Hs, ErrorMessage as Ht, ChangeList as Hu, _isCustomDocumentTypeDefinition as I, getPreviewPaths as Ia, UrlInputProps as Ic, type resolveConfig as Id, LegacyLayerProvider as If, isAgentBundleName as Ii, FormCell as Il, ChangeIndicator as Im, SearchButton as In, useReferringDocuments as Io, DocumentStatusIndicator as Ip, useEventsStore as Ir, defaultRenderAnnotation as Is, getWorkspaceIdentifier as It, TIMELINE_ITEM_I18N_KEY_MAPPING as Iu, isRecord as J, DocumentPreviewPresenceProps as Ja, CreateButton as Jc, CorsProbeOutcome as Jd, useOnScroll as Jf, getSearchableTypes as Ji, FormField as Jl, CommentFieldCreatePayload as Jm, ColorSchemeLocalStorageProvider as Jn, UseFormattedDurationOptions as Jo, CommandListGetItemSelectedCallback as Jp, LoadingState as Jr, useReferenceInputOptions as Js, StudioProviderProps as Jt, getAnnotationAtPath as Ju, isTruthy as K, PresenceScopeProps as Ka, SelectInput as Kc, StudioErrorHandler as Kd, ScrollContextValue as Kf, SearchTerms as Ki, FormFieldSet as Kl, CommentCreatePayload as Km, Filters as Kn, useGlobalCopyPasteElementHandler as Ko, CommandListGetItemDisabledCallback as Kp, LoadableState as Kr, ReferenceInputOptionsProvider as Ks, useTelemetryConsent as Kt, useDiffAnnotationColor as Ku, _isSanityDocumentTypeDefinition as L, unstable_useValuePreview as La, TextInput$1 as Lc, prepareConfig as Ld, ZIndexContextValueKey as Lf, useScheduledDraftsEnabled as Li, FormRow as Ll, ChangeIndicatorProps as Lm, PartialIndexSettings as Ln, useReconnectingToast as Lo, DocumentVersionsStatus as Lp, EventsProvider as Lr, defaultRenderBlock as Ls, WorkspaceLike as Lt, ChangeTitleSegment as Lu, supportsTouch as M, VersionChip as Ma, ArrayOfObjectsInputMembersProps as Mc, resolveSchemaTypes as Md, operationEvents as Mf, MockAuthStoreOptions as Mi, FormValueContextValue as Ml, CommentDeleteDialog as Mm, StudioToolMenu as Mn, useSyncState as Mo, ErrorWithId as Mp, DocumentPermission as Mr, FileInputProps as Ms, useVisibleWorkspaces as Mt, DiffErrorBoundaryProps as Mu, escapeField as N, Chip as Na, ArrayOfObjectsInputMember as Nc, CreateWorkspaceFromConfigOptions as Nd, AvatarSkeleton as Nf, createMockAuthStore as Ni, FormValueProvider as Nl, ChangeConnectorRoot as Nm, StudioNavbar as Nn, useStudioUrl as No, ErrorActions as Np, getDocumentPairPermissions as Nr, StudioFileInput as Ns, VisibleWorkspacesContextValue as Nt, DiffErrorBoundaryState as Nu, userHasRole as O, getVersionInlineBadge as Oa, PrimitiveMemberItemProps as Oc, useDivergenceNavigator as Od, InitialValueSuccessMsg as Of, UpsellDialogViewedInfo as Oh, createConnectionStatusStore as Oi, FieldActionMenu as Ol, CommentsList as Om, StudioWorkspaceManifest as On, getPairTarget as Oo, HotkeysProps$1 as Op, DocumentValuePermissionsOptions as Or, EnhancedObjectDialogContextValue as Os, validateNames as Ot, DiffFromTo as Ou, fieldNeedsEscape as P, prepareForPreview as Pa, ArrayOfObjectsMemberProps as Pc, createSourceFromConfig as Pd, UserAvatar as Pf, AgentVersionDisplay as Pi, useFormValue as Pl, ChangeConnectorRootProps as Pm, StudioLogo as Pn, useReviewChanges as Po, ErrorActionsProps as Pp, useDocumentPairPermissions as Pr, FormProvider as Ps, VisibleWorkspacesProvider as Pt, DiffCard as Pu, getTargetDocument as Q, useGetDefaultPerspective as Qa, PortableTextMemberItem as Qc, documentFieldActionsReducer as Qd, Resizable as Qf, SchedulesContext as Qi, resolveDiffComponent as Ql, CommentOperations as Qm, useColorSchemeInternalValue as Qn, useEditState as Qo, CommandListRenderItemCallback as Qp, useDocumentType as Qr, useTemplatePermissions as Qs, isValidAnnouncementAudience as Qt, HexColor as Qu, _isType as R, useValuePreview as Ra, TextInputProps as Rc, AuthStoreOptions as Rd, ZIndexContextValue as Rf, useScheduledDraftDocument as Ri, FormFieldValidation as Rl, ChangeFieldWrapper as Rm, useSearchMaxFieldDepth as Rn, useProjectId as Ro, DocumentStatus as Rp, useEvents as Rr, defaultRenderField as Rs, CorsOriginErrorScreen as Rt, ChangesError as Ru, isPublishedVersion as S, useOnlyHasVersions as Sa, MemberFieldSet as Sc, DocumentGroupInventoryAction as Sd, InitialValueOptions as Sf, GrantsStore as Sh, ConnectingStatus as Si, useHoveredField as Sl, CommentsAuthoringPathProvider as Sm, uploadSchema as Sn, TimeAgoOpts as So, PopoverDialog as Sp, TimelineState as Sr, isArrayOfPrimitivesInputProps as Ss, prepareTemplates as St, DiffTooltipProps as Su, readVersionType as T, useDocumentVersionTypeSortedList as Ta, MemberFieldProps as Tc, DocumentGroupInventoryPerspectiveList as Td, InitialValueLoadingMsg as Tf, UpsellDialogLearnMoreCtaClicked as Th, ConnectionStatusStoreOptions as Ti, FieldActionsProps as Tl, CommentInput as Tm, generateStudioManifest as Tn, CreatableTargetDocument as To, InsufficientPermissionsMessage as Tp, GrantsStoreOptions as Tr, isObjectInputProps as Ts, DEFAULT_STUDIO_CLIENT_OPTIONS as Tt, DiffStringSegment as Tu, isPausedCardinalityOneRelease as U, PreviewLoader as Ua, StringInput as Uc, RequestErrorChannel as Ud, TextWithToneProps as Uf, SearchFactoryOptions as Ui, FormFieldValidationStatusProps as Ul, CommentsContextValue as Um, SearchPopover as Un, UseListFormatOptions as Uo, ContextMenuButton as Up, isNewDocument as Ur, EditReferenceLinkComponentProps as Us, ErrorMessageProps as Ut, ChangeListProps as Uu, isCardinalityOnePerspective as V, SanityDefaultPreview as Va, TagsArrayInput as Vc, _createAuthStore as Vd, TooltipOfDisabled as Vf, useSingleDocRelease as Vi, FormFieldValidationWarning as Vl, useCanvasCompanionDoc as Vm, SearchContextValue as Vn, UseManageFavoriteProps as Vo, MetadataWrapper as Vp, useInitialValueResolverContext as Vr, defaultRenderItem as Vs, useWorkspaceLoader as Vt, GroupChange as Vu, measureFirstEmission as W, Preview as Wa, SlugInput as Wc, RequestErrorClaim as Wd, StatusButton as Wf, SearchOptions as Wi, FieldStatusProps as Wl, CommentBaseCreatePayload as Wm, SearchPopoverProps as Wn, useListFormat as Wo, CommandList as Wp, useDocumentValues as Wr, EditReferenceOptions as Ws, InterpolationProp as Wt, ChangeBreadcrumb as Wu, isArray as X, useSetPerspective as Xa, getPreviewStateObservable as Xc, WorkspacesProviderProps as Xd, RovingFocusNavigationType as Xf, getSchemaTypeTitle as Xi, EnhancedObjectDialog as Xl, CommentListBreadcrumbs as Xm, ColorSchemeProviderProps as Xn, useFilteredReleases as Xo, CommandListItemContext as Xp, useLoadable as Xr, TemplatePermissionsResult as Xs, NavbarContextValue as Xt, getDiffAtPath as Xu, isNonNullable as Y, useSetVariant as Ya, CreateReferenceOption as Yc, WorkspacesProvider as Yd, useRovingFocus as Yf, compileFieldPath as Yi, FormFieldProps as Yl, CommentIntentGetter as Ym, ColorSchemeProvider as Yn, useFormattedDuration as Yo, CommandListHandle as Yp, asLoadable as Yr, TemplatePermissionsOptions as Ys, StudioLayoutComponent as Yt, getAnnotationColor as Yu, globalScope as Z, usePerspective as Za, PortableTextInput as Zc, flattenConfig as Zd, RovingFocusProps as Zf, createSchema as Zi, EditPortal as Zl, CommentMessage as Zm, useColorScheme as Zn, useFeatureEnabled as Zo, CommandListProps as Zp, DocumentTypeResolveState as Zr, getTemplatePermissions as Zs, StudioLayout as Zt, visitDiff as Zu, useVariantDocumentOperations as _, useArchivedReleases as _a, ObjectInputMembers as _c, StudioFeedbackDialogProps as _d, QueryParams$1 as _f, UserWithPermission as _h, createUserStore as _i, ArrayOfObjectOptionsInput as _l, CommentsSelectedPathProvider as _m, parseRetryAfter as _n, FormattableMeasurementUnit as _o, CompactPreviewProps as _p, getProjectGrants as _r, ConnectionState as _s, resolveInitialObjectValue as _t, FromToProps as _u, ImageUrlBuilder$1 as a, isDraftPerspective as aa, useParseErrorForPath as ac, UseFeedbackReturn as ad, defineConfig as af, CommentTaskCreatePayload as ah, useGrantsStore as ai, getCalendarLabels as al, CapabilityGate as am, useStudioErrorHandler as an, useDocumentLimitsUpsellContext as ao, InlinePreview as ap, MatchWorkspaceOptions as ar, useConditionalToast as as, UserColorManagerProviderProps as at, isUnchangedDiff as au, VersionType as b, sortReleases as ba, ObjectInputMember as bc, isDev as bd, ListenQueryParams as bf, EvaluationParams as bh, CONNECTING as bi, useDidUpdate as bl, CommentsEnabledProvider as bm, isUnauthorizedError as bn, useUnitFormatter as bo, ReferenceInputPreviewCard as bp, createKeyValueStore as br, isArrayOfBlocksInputProps as bs, defaultTemplateForType as bt, Event$1 as bu, ResetEvent as c, RELEASES_STUDIO_CLIENT_OPTIONS as ca, FormCallbacksProvider as cc, UseInStudioFeedbackReturn as cd, ConfigResolutionErrorOptions as cf, CommentUpdateOperationOptions as ch, usePresenceStore as ci, DateInput$1 as cl, buildTextSelectionFromFragment as cm, createRequestErrorChannel as cn, useI18nText as co, BlockImagePreview as cp, WorkspacesContextValue as cr, encodePath as cs, useUserColor as ct, ValueError as cu, WelcomeBackEvent as d, getReleaseTone as da, createSanityMediaLibraryFileSource as dc, DynamicFeedbackTags as dd, useMiddlewareComponents as df, CommentsTextSelectionItem as dh, useUserStore as di, BooleanInput as dl, useCommentsTelemetry as dm, RequestErrorClassification as dn, defineLocalesResources as do, MediaPreviewProps as dp, RouterHistory as dr, toMutationPatches as ds, LegacyThemeProps as dt, NoChanges as du, ScheduledBadge as ea, PartialExcept as ec, UserColorHue as ed, initialDocumentFieldActions as ef, CommentPostPayload as eh, remoteSnapshots as ei, ObjectInput as el, CollapseMenuButtonProps as em, StudioAnnouncementsDialog as en, ReleasesNav as eo, RelativeTimeProps as ep, useColorSchemeSetValue as er, useDocumentOperation as es, getReferencePaths as et, emptyValuesByType as eu, WelcomeEvent as f, getReleaseIdFromReleaseDocumentId as fa, createSanityMediaLibraryImageSource as fc, FeedbackContextValue as fd, ZIndexProvider as ff, CommentsType as fh, PresenceStore as fi, UniversalArrayInput as fl, useCommentsSelectedPath as fm, classifyConfigError as fn, removeUndefinedLocaleResources as fo, DetailPreview as fp, useCurrentUser as fr, useFormBuilder as fs, LegacyThemeTints as ft, MetaInfo as fu, useAllVariants as g, useDocumentVersionInfo as ga, resolveConditionalProperty as gc, StudioFeedbackDialog as gd, DocumentStoreOptions as gf, UserListWithPermissionsOptions as gh, UserStoreOptions as gi, ArrayOfOptionsInput as gl, isTextSelectionComment as gm, isTimeoutError as gn, useValidationStatus as go, CompactPreview as gp, createProjectStore as gr, useDocumentSyncState as gs, isBuilder as gt, FromTo as gu, getVariantTitle as h, useReleasesIds as ha, ALL_FIELDS_GROUP as hc, TagValue as hd, DocumentStore as hf, UserListWithPermissionsHookValue as hh, UserStore as hi, ArrayOfPrimitiveOptionsInput as hl, hasCommentMessageValue as hm, isNetworkError as hn, useVersionRelease as ho, DefaultPreviewProps as hp, useProject as hr, deriveDocumentSyncState as hs, Serializeable as ht, FromToArrowDirection as hu, DEFAULT_LIST_TYPES as i, getDocumentIsInPerspective as ia, ParseErrorsProvider as ic, FeedbackContext$1 as id, createConfig as if, CommentStatus as ih, useDocumentStore as ii, EmailInputProps as il, CollapseMenuProps as im, StudioProps as in, isDocumentLimitError as io, TemplatePreviewProps as ip, useActiveWorkspace as ir, useDataset as is, UserColorManagerProvider as it, isRemovedItemDiff as iu, uncaughtErrorHandler as j, ReleaseAvatarIcon as ja, ArrayOfObjectsInputMembers as jc, SchemaError as jd, emitOperation as jf, isCookielessCompatibleLoginMethod as ji, useGetFormValue as jl, CommentDisabledIcon as jm, ToolLinkProps as jn, SyncState as jo, useCopyErrorDetails as jp, DocumentPairPermissionsOptions as jr, StudioImageInput as js, evaluateWorkspaceHidden as jt, DiffErrorBoundary as ju, sliceString as k, ReleaseTitle as ka, ArrayOfObjectsItem as kc, getConfigContextFromSource as kd, OperationError as kf, AddonDatasetContextValue as kh, onRetry as ki, FieldActionMenuProps as kl, CommentsSelectedPath as km, StudioFeedbackProvider as kn, getTargetScopeId as ko, GetHookCollectionState as kp, getDocumentValuePermissions as kr, useEnhancedObjectDialog as ks, validateWorkspaces as kt, DiffFromToProps as ku, SanityClient$1 as l, isReleasePerspective as la, FormCallbacksValue as lc, useInStudioFeedback as ld, ConfigPropertyError as lf, CommentUpdatePayload as lh, useProjectStore as li, DateInputProps as ll, buildRangeDecorationSelectionsFromComments as lm, passthroughErrorHandler as ln, defineLocale as lo, BlockImagePreviewProps as lp, ActiveWorkspaceMatcher as lr, MutationPatch as ls, useUserColorManager as lt, RevertChangesConfirmDialog as lu, SANITY_VERSION as m, PUBLISHED as ma, mergeParseErrors as mc, Sentiment as md, WithReferringDocuments as mf, Loadable as mh, createPresenceStore as mi, ArrayOfPrimitivesFunctions as ml, useComments as mm, isClientRequestError as mn, useWorkspaceSchemaId as mo, DefaultPreview as mp, useProjectDatasets as mr, DocumentSyncState as ms, RESOLVE_INITIAL_VALUE_TIMEOUT_MS as mt, FromToArrow as mu, DEFAULT_BLOCK_STYLES as n, EditScheduleForm as na, ReactHook as nc, UserId as nd, createPlugin as nf, CommentReactionOption as nh, useConnectionStatusStore as ni, AssetAccessPolicy as nl, AutoCollapseMenu as nm, StudioAnnouncementsCard as nn, isPerspectiveWriteable as no, CircularProgress as np, useAddonDataset as nr, useDocumentIdStack as ns, formatRelativeLocale as nt, isFieldChange as nu, ReconnectEvent as o, isPublishedPerspective as oa, useParseErrors as oc, useFeedback as od, createDefaultIcon as of, CommentTextSelection as oh, useHistoryStore as oi, DateTimeInput as ol, BetaBadge as om, RequestErrorDialog as on, useGetI18nText as oo, InlinePreviewProps as op, MatchWorkspaceResult as or, useClient as os, UserColorManagerOptions as ot, noop as ou, getProviderTitle$1 as p, LATEST as pa, ParseError as pc, FeedbackPayload as pd, useZIndex as pf, CommentsUIMode as ph, SESSION_ID as pi, ArrayOfPrimitivesInput as pl, useCommentsEnabled as pm, classifyRequestError as pn, ValidationLocaleResourceKeys as po, DetailPreviewProps as pp, useUser as pr, useDocumentForm as ps, DEFAULT_MAX_RECURSION_DEPTH as pt, MetaInfoProps as pu, isString as q, DocumentPreviewPresence as qa, ReferenceAutocomplete as qc, CorsCheckResult as qd, ScrollEventHandler as qf, isPerspectiveRaw as qi, FormFieldSetProps as ql, CommentDocument as qm, ColorSchemeCustomProvider as qn, FormattedDuration as qo, CommandListGetItemKeyCallback as qp, LoadedState as qr, TemplateOption as qs, StudioProvider as qt, DiffVisitor as qu, DEFAULT_DECORATORS as r, formatRelativeLocalePublishDate as ra, createHookFromObservableFactory as rc, useStudioFeedbackTags as rd, definePlugin as rf, CommentReactionShortNames as rh, useDocumentPreviewStore as ri, EmailInput as rl, CollapseMenu as rm, Studio as rn, getSelectedVariant as ro, TemplatePreview as rp, AddonDatasetProvider as rr, useDialogStack as rs, catchWithCount as rt, isGroupChange as ru, ReleaseDocument$1 as s, isReleaseScheduledOrScheduling as sa, useReportParseError as sc, SendFeedbackOptions as sd, ConfigResolutionError as sf, CommentThreadItem as sh, useKeyValueStore as si, DateTimeInputProps as sl, BetaBadgeProps as sm, useRetryCountdown as sn, I18nNode as so, BlockPreview as sp, matchWorkspace as sr, decodePath as ss, createUserColorManager as st, DocumentChangeContextInstance as su, DEFAULT_ANNOTATIONS as t, useScheduleAction as ta, LoadingTuple as tc, UserColorManager as td, PluginFactory as tf, CommentReactionItem as th, useComlinkStore as ti, NumberInput as tl, CommonProps as tm, StudioAnnouncementsContextValue as tn, PerspectiveNotWriteableReason as to, LinearProgress as tp, useColorSchemeValue as tr, DocumentIdStack as ts, getErrorMessage as tt, isAddedItemDiff as tu, TFunction$1 as u, isGoingToUnpublish as ua, useFormCallbacks as uc, BaseFeedbackTags as ud, ConfigPropertyErrorOptions as uf, CommentsListBreadcrumbItem as uh, useRenderingContextStore as ui, CrossDatasetReferencePreview as ul, buildCommentRangeDecorations as um, ConfigErrorClassification as un, defineLocaleResourceBundle as uo, MediaPreview as up, ActiveWorkspaceMatcherProps as ur, fromMutationPatches as us, buildLegacyTheme as ut, RevertChangesButton as uu, useCreatableVariantInitialValue as v, useActiveReleases as va, ObjectMembers as vc, FeedbackDialog as vd, createDocumentStore as vf, useUserListWithPermissions as vh, KeyValueStore as vi, ArrayOfObjectsInput as vl, CommentsIntentProvider as vm, getApiErrorCode as vn, UnitFormatter as vo, PreviewCard as vp, useGlobalPresence as vr, connectionState as vs, resolveInitialValue as vt, FieldChange as vu, isVariantVersion as w, useFormatRelativeLocalePublishDate as wa, MemberField as wc, DocumentGroupInventoryProps as wd, InitialValueErrorMsg as wf, UpsellDialogDismissed as wh, ConnectionStatusStore as wi, useFieldActions as wl, CommentInlineHighlightSpan as wm, GenerateStudioManifestOptions as wn, useTemplates as wo, IntentButton as wp, useTimelineStore as wr, isNumberInputProps as ws, IsLastPaneProvider as wt, DiffString as wu, isDraftVersion as x, useVersionOperations as xa, ObjectInputMemberProps as xc, isProd as xd, listenQuery as xf, Grant as xh, ConnectedStatus as xi, FormBuilderContextValue as xl, CommentsProvider as xm, renderStudio as xn, useTools as xo, usePreviewCard as xp, useTimelineSelector as xr, isArrayOfObjectsInputProps as xs, defaultTemplatesForSchema as xt, DiffTooltip as xu, isDocumentInSelectedVariant as y, RELEASES_INTENT as ya, ObjectMembersProps as yc, FeedbackDialogProps as yd, ListenQueryOptions as yf, DocumentValuePermission as yh, KeyValueStoreValue as yi, ArrayOfObjectsFunctions as yl, CommentsIntentProviderProps as ym, isInvalidSessionError as yn, UseUnitFormatterOptions as yo, PreviewCardContextValue as yp, useDocumentPresence as yr, useConnectionState as ys, resolveInitialValueForType as yt, FallbackDiff as yu, createSWR as z, unstable_useObserveDocument as za, TelephoneInput as zc, CreateAuthStoreOptions as zd, ImperativeToast as zf, usePausedScheduledDraft as zi, FormFieldValidationError as zl, getDocumentIdForCanvasLink as zm, useSearchState as zn, UseNumberFormatOptions as zo, VersionInfoDocumentStub as zp, useResolveInitialValueForType as zr, defaultRenderInlineBlock as zs, ConfigErrorGate as zt, ChangeResolver as zu };
//# sourceMappingURL=index-D8ZhILGd.d.ts.map