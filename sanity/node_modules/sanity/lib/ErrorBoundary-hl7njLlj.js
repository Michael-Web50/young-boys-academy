...
function ErrorBoundary$1(t0) {
	...
	return $[6] !== handleCatch || $[7] !== rest ? (t2 = /* @__PURE__ */ jsx(ErrorBoundary, {
		...rest,
		onCatch: handleCatch
	}), $[6] = handleCatch, $[7] = rest, $[8] = t2) : t2 = $[8], t2;
}
export { ErrorBoundary$1 as t };

//# sourceMappingURL=ErrorBoundary-hl7njLlj.js.map