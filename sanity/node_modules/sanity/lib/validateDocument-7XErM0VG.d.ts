import { CSSProperties, ClipboardEventHandler, ComponentProps, ComponentType, ElementType, ErrorInfo, FocusEvent, FocusEventHandler, FormEventHandler, HTMLProps, PropsWithChildren, ReactNode, RefAttributes, RefObject } from "react";
import { Observable, Subject } from "rxjs";
import { DocumentDivergencesContextValue, LocaleContextValue } from "sanity/_singletons";
import { ArraySchemaType, AssetMetadataType, AssetSource, AssetSourceSpec, BlockDecoratorDefinition, BlockListDefinition, BlockStyleDefinition, BooleanSchemaType, ConditionalProperty, CrossDatasetReferenceSchemaType, CrossDatasetReferenceValue, CrossDatasetType, CurrentUser, DeprecatedProperty, DocumentSystem, FileValue, FormNodeValidation, GeopointValue, GlobalDocumentReferenceType, I18nTextRecord, ImageUrlFitMode, ImageValue, IndexTuple, InitialValueProperty, IntrinsicTypeName, KeyedObject, KeyedSegment, MendozaEffectPair, NumberSchemaType, ObjectField, ObjectFieldType, ObjectSchemaType, PatchOperations, Path, PathSegment, PortableTextBlock, PortableTextObject, PortableTextTextBlock, PrepareViewOptions, PreviewValue, Reference, ReferenceSchemaType, ReferenceValue, Role, RuleClass, SanityDocument, SanityDocumentLike, Schema, SchemaType, SchemaTypeDefinition, SearchStrategy, SlugValue, StringSchemaType, TransactionLogEventWithEffects, TransactionLogEventWithMutations, User, ValidationContext as ValidationContext$1, ValidationMarker } from "@sanity/types";
import { AvatarPosition, ButtonTone, DialogProps } from "@sanity/ui";
...
export { ExpandOperation as $, isCreateLiveDocumentEvent as $a, ArrayOfPrimitivesMember as $c, checkoutPair as $i, getDraftId as $l, SanityFormConfig as $n, I18nSearchOperatorNameKey as $o, FormComponents as $r, PrimitiveFieldProps as $s, useChangeIndicatorsReporter as $t, FormUnsetPatch as $u, FieldPresenceInnerProps as A, StringSegmentChanged$1 as Aa, BlockListItemProps as Ac, DocumentVersionSnapshots as Ai, Uploader as Al, DocumentBadgesContext as An, RemoteSnapshotEvent as Ao, DocumentPreviewStore as Ar, LocaleSource as As, FIXME as At, DocumentFieldAction as Au, UseTranslationResponse as B, DeleteDocumentVersionEvent as Ba, DocumentFormNode as Bc, ParsedTimeRef as Bi, TargetPerspective as Bl, FormBuilderComponentResolverContext as Bn, TemplateFieldDefinition as Bo, DraftsModelDocumentAvailability as Br, FormBuilderMarkersComponent as Bs, pathToString as Bt, DocumentFieldActionsResolverContext as Bu, ProjectGrants as C, ItemDiff$1 as Ca, RenderFieldCallback as Cc, SanityDefinedAction as Ci, ArrayInputMoveItemEvent as Cl, ConfigContext as Cn, PendingMutationsEvent as Co, ReleaseActionProps as Cr, LocaleConfigContext as Cs, DivergencesProvider as Ct, Size as Cu, PresenceOverlayProps as D, ReferenceDiff as Da, RenderPreviewCallbackProps as Dc, OperationArgs as Di, ResolvedUploader as Dl, DocumentActionsResolver as Dn, DocumentRebaseEvent as Do, SourceProvider as Dr, LocaleResourceBundle as Ds, FormInputRelativePathArg as Dt, Session as Du, PresenceOverlay as E, ObjectDiff$1 as Ea, RenderPreviewCallback as Ec, Operation as Ei, FileLike as El, DocumentActionsContext as En, DocumentMutationEvent as Eo, Rule as Er, LocalePluginOptions as Es, FormInputAbsolutePathArg as Et, PresenceLocation as Eu, TranslateComponentMap as F, StudioLocaleResourceKeys as Fa, ArrayOfObjectsFormNode as Fc, createHistoryStore as Fi, PerspectiveContextValue as Fl, DocumentLanguageFilterComponent as Fn, StudioTheme as Fo, AvailabilityReason as Fr, TFunction$1 as Fs, isEmptyObject as Ft, DocumentFieldActionNode as Fu, LocaleProviderBase as G, EventsStoreRevision as Ga, ObjectArrayFormNode as Gc, Transaction as Gi, DraftId as Gl, NewDocumentOptionsContext as Gn, SearchOperatorDefinitionDictionary as Go, ObserveDocumentTypeFromIdFn as Gr, ArrayFieldProps as Gs, useFormState as Gt, FormInsertPatch as Gu, useCurrentLocale as H, DocumentVersionEventType as Ha, NodeChronologyProps as Hc, TimelineOptions as Hi, VARIANTS_STUDIO_CLIENT_OPTIONS as Hl, MediaLibraryConfig as Hn, TemplateParameter as Ho, Id as Hr, RenderBlockActionsCallback as Hs, stringToPath as Ht, FormDecPatch as Hu, TranslationProps as I, BaseEvent as Ia, ArrayOfPrimitivesFormNode as Ic, removeMissingReferences as Ii, PerspectiveStack as Il, DocumentLanguageFilterContext as In, StudioThemeColorSchemeKey as Io, AvailabilityResponse as Ir, ArrayInputFunctionsProps as Is, normalizeIndexSegment as It, DocumentFieldActionProps as Iu, useDateTimeFormat as J, ScheduleDocumentVersionEvent as Ja, PrimitiveFormNode as Jc, DocumentVersionEvent as Ji, VERSION_FOLDER as Jl, Plugin as Jn, defineSearchFilter as Jo, PreviewPath as Jr, BooleanFieldProps as Js, ScrollContainerProps as Jt, FormPatchBase as Ju, useSchema as K, HistoryClearedEvent as Ka, ObjectFormNode as Kc, CommitError as Ki, PublishedId as Kl, NewDocumentOptionsResolver as Kn, SearchFilterDefinition as Ko, ObservePathsFn as Kr, ArrayOfPrimitivesFieldProps as Ks, StateTree as Kt, FormInsertPatchPosition as Ku, defaultLocale as L, CreateDocumentVersionEvent as La, BaseFormNode as Lc, SelectionState as Li, ReleaseId as Ll, DocumentLanguageFilterResolver as Ln, InitialValueTemplateItem as Lo, DocumentAvailability as Lr, FormBuilderCustomMarkersComponent as Ls, normalizeIndexTupleSegment as Lt, DocumentFieldActionStatus as Lu, FieldPresenceWithOverlay as M, TypeChangeDiff$1 as Ma, BlockStyleProps as Mc, DocumentRevision as Mi, UploaderResolver as Ml, DocumentCommentsEnabledContext as Mn, StoreRequestErrorHandler as Mo, ObserveForPreviewFn as Mr, LocalesBundlesOption as Ms, getItemKey as Mt, DocumentFieldActionGroup as Mu, PerspectiveProvider as N, FieldValueError as Na, MarkdownConfig as Nc, HistoryStore as Ni, ProvenanceDiffAnnotation as Nl, DocumentInspectorContext as Nn, defaultTheme as No, createDocumentPreviewStore as Nr, LocalesOption as Ns, getItemKeySegment as Nt, DocumentFieldActionHook as Nu, FieldPresence as O, StringDiff$1 as Oa, BlockAnnotationProps as Oc, OperationImpl as Oi, UploadOptions as Ol, DocumentActionsVersionType as On, DocumentRemoteMutationEvent as Oo, SourceProviderProps as Or, LocaleResourceKey as Os, FormFieldHeaderText as Ot, Status as Ou, Translate as P, getValueError as Pa, PortableTextPluginsProps as Pc, HistoryStoreOptions as Pi, PerspectiveBundle as Pl, DocumentInspectorsResolver as Pn, StudioColorScheme as Po, ApiConfig as Pr, StaticLocaleResourceBundle as Ps, getValueAtPath as Pt, DocumentFieldActionItem as Pu, ExpandFieldSetOperation as Q, isCreateDocumentVersionEvent as Qa, ArrayOfPrimitivesItemMember as Qc, WithVersion as Qi, documentIdEquals as Ql, ResolveProductionUrlContext as Qn, I18nSearchOperatorDescriptionKey as Qo, ObserveDocumentAPIConfig as Qr, ObjectFieldProps as Qs, useChangeIndicatorsReportedValues as Qt, FormSetPatch as Qu, usEnglishLocale as R, CreateLiveDocumentEvent as Ra, BooleanFormNode as Rc, TimelineController as Ri, ReleasesNavMenuItemPropsGetter as Rl, DocumentLayoutProps as Rn, Template as Ro, DocumentStackAvailability as Rr, FormBuilderFilterFieldFn as Rs, normalizeKeySegment as Rt, DocumentFieldActionTone as Ru, ProjectDatasetData as S, GroupChangeNode as Sa, RenderBlockCallback as Sc, DuplicateDocumentActionComponent as Si, ArrayInputInsertEvent as Sl, Config as Sn, MutationEvent as So, ReleaseActionDescription as Sr, Locale as Ss, FormDocumentValue as St, ReportedRegionWithRect as Su, ProjectStore as T, NumberDiff$1 as Ta, RenderItemCallback as Tc, MapDocument as Ti, AssetSourcesResolver as Tl, DefaultPluginsWorkspaceOptions as Tn, CommittedEvent as To, ValidationStatus as Tr, LocaleNestedResource as Ts, FormInput as Tt, GlobalPresence as Tu, useLocale as U, EditDocumentVersionEvent as Ua, NodeDiffProps as Uc, CombinedDocument as Ui, CollatedHit as Ul, MissingConfigFile as Un, TemplateReferenceTarget as Uo, InvalidationChannelEvent as Ur, RenderBlockActionsProps as Us, FormState as Ut, FormDiffMatchPatch as Uu, useTranslation$1 as V, DocumentGroupEvent as Va, HiddenField as Vc, Timeline as Vi, SystemVariant as Vl, GroupableActionDescription as Vn, TemplateItem as Vo, FieldName as Vr, PortableTextMarker as Vs, pathsAreEqual as Vt, PatchEvent as Vu, LocaleProvider as W, EventsStore as Wa, NumberFormNode as Wc, DocumentRemoteMutationVersionEvent as Wi, DRAFTS_FOLDER as Wl, NewDocumentCreationContext as Wn, TypeTarget as Wo, ObserveDocumentAvailabilityFn as Wr, RenderCustomMarkers as Ws, UseFormStateOptions as Wt, FormIncPatch as Wu, FormBuilder as X, UnscheduleDocumentVersionEvent as Xa, ArrayOfObjectsItemMember as Xc, Pair as Xi, createDraftFrom as Xl, PreparedConfig as Xn, SearchOperatorType as Xo, PreviewableType as Xr, FieldProps as Xs, useRelativeTime as Xt, FormPatchOrigin as Xu, TransformPatches as Y, UnpublishDocumentEvent as Ya, StringFormNode as Yc, MutationResult as Yi, collate as Yl, PluginOptions as Yn, defineSearchFilterOperators as Yo, Previewable as Yr, FieldCommentsProps as Ys, RelativeTimeOptions as Yt, FormPatchJSONValue as Yu, FormBuilderProps as Z, UpdateLiveDocumentEvent as Za, ArrayOfObjectsMember as Zc, RemoteSnapshotVersionEvent as Zi, createPublishedFrom as Zl, ReleaseActionsResolver as Zn, operatorDefinitions as Zo, Selection as Zr, NumberFieldProps as Zs, ChangeIndicatorsTracker as Zt, FormSetIfMissingPatch as Zu, ResourceCache as _, DiffComponentResolver as _a, PrimitiveInputProps as _c, DocumentActionKeys as _i, ItemProps as _l, AsyncComposableOption as _n, ListenerEvent as _o, NavbarProps as _r, AuthConfig as _s, PatchChannel as _t, Location as _u, EMPTY_OBJECT as a, Annotation as aa, BooleanInputProps as ac, PreviewLayoutKey as ad, defineDocumentInspector as ai, FieldsetMembers as al, TrackedArea as an, isUnpublishDocumentEvent as ao, SourceOptions as ar, SearchOperatorInput as as, dec as at, isDraft as au, useResourceCache as b, FieldOperationsAPI as ba, RenderArrayOfObjectsItemCallback as bc, DocumentActionProps as bi, PrimitiveItemProps as bl, BetaFeatures as bn, DocumentPairTarget as bo, ToolMenuProps as br, LoginMethod as bs, RebasePatchMsg as bt, Rect as bu, useWorkspace as c, ArrayItemMetadata as ca, InputOnSelectFileFunctionProps as cc, DocumentBadgeProps as ci, DuplicateKeysError as cl, TrackerContextStore as cn, DocumentVariantType as co, Workspace as cr, ValuelessSearchOperatorBuilder as cs, insert as ct, isSystemBundle as cu, BaseOptions as d, ChangeTitlePath as da, ObjectInputProps as dc, DocumentActionComponent as di, InvalidItemTypeError as dl, IsEqualFunction as dn, editState as do, WorkspaceOptions as dr, SearchFieldDefinitionDictionary as ds, setIfMissing as dt, newDraftFrom as du, BufferedDocumentEvent as ea, StringFieldProps as ec, PatchArg as ed, DocumentInspector as ei, DecorationMember as el, StudioReferenceInput as en, isDeleteDocumentGroupEvent as eo, ScheduledPublishingPluginOptions as er, OperatorButtonValueComponentProps as es, ExpandPathOperation as et, getIdPair as eu, CopyOptions as f, Chunk as fa, OnPasteFn as fc, DocumentActionConfirmDialogProps as fi, MissingKeysError as fl, Reported as fn, DocumentPairLoadedEvent as fo, WorkspaceSummary as fr, AuthProbeResult as fs, unset as ft, removeDupes as fu, SanityClipboardItem as g, DiffComponentOptions as ga, PrimitiveInputElementProps as gc, DocumentActionGroup as gi, BaseItemProps as gl, AssetSourceResolver as gn, LatencyReportEvent as go, NavbarAction as gr, LoginComponentProps as gs, MutationPatchMsg as gt, FormNodePresence as gu, PasteOptions as h, DiffComponent as ha, PortableTextInputProps as hc, DocumentActionDialogProps as hi, UndeclaredMembersError as hl, AppsOptions as hn, InitialSnapshotEvent as ho, LogoProps as hr, HandleCallbackResult as hs, useVirtualizerScrollInstance as ht, FieldPresenceData as hu, EMPTY_ARRAY as i, createObservableBufferedDocument as ia, BaseInputProps as ic, PreviewComponent as id, DocumentInspectorUseMenuItemProps as ii, ObjectMember as il, ChangeIndicatorTrackerContextValue as in, isScheduleDocumentVersionEvent as io, SourceClientOptions as ir, SearchOperatorButtonValue as is, SANITY_PATCH_TYPE as it, idMatchesPerspective as iu, FieldPresenceProps as j, StringSegmentUnchanged$1 as ja, BlockProps as jc, snapshotPair as ji, UploaderDef as jl, DocumentBadgesResolver as jn, SnapshotEvent as jo, DocumentPreviewStoreOptions as jr, LocaleWeekInfo as js, findIndex as jt, DocumentFieldActionDivider as ju, FieldPresenceInner as k, StringDiffSegment as ka, BlockDecoratorProps as kc, OperationsAPI as ki, UploadProgressEvent as kl, DocumentAskToEditEnabledContext as kn, MutationPayload as ko, useSource as kr, LocaleResourceRecord as ks, FormFieldHeaderTextProps as kt, UserSessionPair as ku, CopyPasteProvider as l, BooleanDiff$1 as la, InputProps as lc, GetHookCollectionStateProps as li, FieldError as ll, useTrackerStore as ln, getDocumentVariantType as lo, WorkspaceHiddenContext as lr, ValuelessSearchOperatorParams as ls, prefixPath as lt, isSystemBundleName as lu, DocumentMeta as m, Diff$1 as ma, PasteData$1 as mc, DocumentActionDescription as mi, TypeAnnotationMismatchError as ml, ActionComponent as mn, DocumentStoreExtraOptions as mo, LayoutProps as mr, AuthStore as ms, VirtualizerScrollInstance as mt, FormFieldGroup as mu, validateDocument as n, createBufferedDocument as na, ArrayOfPrimitivesElementType as nc, GeneralPreviewLayoutKey as nd, DocumentInspectorMenuItem as ni, FieldSetMember as nl, StudioCrossDatasetReferenceInput as nn, isEditDocumentVersionEvent as no, SingleWorkspace as nr, SearchOperatorBase as ns, getExpandOperations as nt, getVersionFromId$1 as nu, WorkspaceProvider as o, AnnotationDetails as oa, ComplexElementProps as oc, PreviewMediaDimensions as od, DocumentBadgeComponent as oi, FieldsetState as ol, TrackedChange as on, isUnscheduleDocumentVersionEvent as oo, TemplateResolver as or, SearchOperatorParams as os, diffMatchPatch as ot, isDraftId as ou, CopyPasteContextType as p, ChunkType as pa, OnPathFocusPayload as pc, DocumentActionCustomDialogComponentProps as pi, MixedArrayError as pl, ReporterHook as pn, DocumentRebaseTelemetryEvent as po, ActiveToolLayoutProps as pr, AuthState as ps, VirtualizerScrollInstanceProvider as pt, systemBundles as pu, UseDateTimeFormatOptions as q, PublishDocumentVersionEvent as qa, ObjectRenderMembersCallback as qc, DocumentVersion as qi, SystemBundle as ql, PartialContext as qn, SearchFilterDefinitionDictionary as qo, PreparedSnapshot as qr, BaseFieldProps as qs, ScrollContainer as qt, FormPatch as qu, ValidationContext$1 as r, CommitRequest as ra, ArrayOfPrimitivesInputProps as rc, PortableTextPreviewLayoutKey as rd, DocumentInspectorProps as ri, FieldsetRenderMembersCallback as rl, StudioCrossDatasetReferenceInputProps as rn, isPublishDocumentVersionEvent as ro, Source as rr, SearchOperatorBuilder as rs, setAtPath as rt, getVersionId as ru, WorkspaceProviderProps as s, ArrayDiff$1 as sa, EditorChange as sc, PreviewProps as sd, DocumentBadgeDescription as si, ArrayItemError as sl, TrackerContextGetSnapshot as sn, isUpdateLiveDocumentEvent as so, Tool as sr, SearchValueFormatterContext as ss, inc as st, isPublishedId$1 as su, ValidateDocumentOptions as t, BufferedDocumentWrapper as ta, ArrayOfObjectsInputProps as tc, GeneralDocumentListLayoutKey as td, DocumentInspectorComponent as ti, FieldMember as tl, StudioReferenceInputProps as tn, isDeleteDocumentVersionEvent as to, SchemaPluginOptions as tr, OperatorInputComponentProps as ts, SetActiveGroupOperation as tt, getPublishedId$1 as tu, useCopyPaste as u, ChangeNode as ua, NumberInputProps as uc, HookCollectionActionHook as ui, IncompatibleTypeError as ul, useTrackerStoreReporter as un, EditStateFor as uo, WorkspaceHiddenProperty as ur, defineSearchOperator as us, set as ut, isVersionId as uu, ResourceCacheProvider as v, DiffProps as va, StringInputProps as vc, DocumentActionModalDialogProps as vi, ObjectItem as vl, AsyncConfigPropertyReducer as vn, MutationPerformanceEvent as vo, StudioComponents as vr, AuthProvider as vs, PatchMsg as vt, Position as vu, ProjectOrganizationData as w, NullDiff$1 as wa, RenderInputCallback as wc, isSanityDefinedAction as wi, UploadEvent as wl, ConfigPropertyReducer as wn, CommitFunction as wo, ReleaseActionsContext as wr, LocaleDefinition as ws, useDocumentDivergences as wt, DocumentPresence as wu, ProjectData as x, FromToIndex as xa, RenderArrayOfPrimitivesItemCallback as xc, DuplicateActionProps as xi, ArrayInputCopyEvent as xl, ComposableOption as xn, IdPair as xo, ReleaseActionComponent as xr, ImplicitLocaleResourceBundle as xs, createPatchChannel as xt, RegionWithIntersectionDetails as xu, ResourceCacheProviderProps as y, FieldChangeNode as ya, RenderAnnotationCallback as yc, DocumentActionPopoverDialogProps as yi, ObjectItemProps as yl, BaseActionDescription as yn, getPairListener as yo, StudioComponentsPluginOptions as yr, CookielessCompatibleLoginMethod as ys, PatchMsgSubscriber as yt, PresentUser as yu, UseTranslationOptions as z, DeleteDocumentGroupEvent as za, ComputeDiff as zc, TimelineControllerOptions as zi, SelectedPerspective as zl, DocumentPluginOptions as zn, TemplateArrayFieldDefinition as zo, DraftsModelDocument as zr, FormBuilderInputComponentMap as zs, normalizePathSegment as zt, DocumentFieldActionsResolver as zu };
//# sourceMappingURL=validateDocument-7XErM0VG.d.ts.map