...
declare const previewUrlMachine: import("xstate").StateMachine<Context$1, SetPreviewSearchParamEvent, {
  [x: string]: import("xstate").ActorRefFromLogic<import("xstate").ObservableActorLogic<PermissionCheckResult, CheckPermissionInput, import("xstate").EventObject> | import("xstate").PromiseActorLogic<URLPattern[], {
    initialUrl: URL;
  }, import("xstate").EventObject> | import("xstate").PromiseActorLogic<URL, ResolvePreviewModeUrlInput, import("xstate").EventObject> | import("xstate").PromiseActorLogic<URL, {
    initialUrl: URL;
    previewSearchParam: string | null | undefined;
    allowOrigins: URLPattern[];
  }, import("xstate").EventObject> | import("xstate").PromiseActorLogic<URL, {
    previewSearchParam: string | null;
  }, import("xstate").EventObject> | import("xstate").PromiseActorLogic<{
    secret: string;
    expiresAt: Date;
  }, import("xstate").NonReducibleUnknown, import("xstate").EventObject> | import("xstate").PromiseActorLogic<string | null, import("xstate").NonReducibleUnknown, import("xstate").EventObject> | import("xstate").PromiseActorLogic<false | PreviewUrlPreviewMode, {
    targetOrigin: string;
...
//# sourceMappingURL=types-Cm3Igb9p.d.ts.map