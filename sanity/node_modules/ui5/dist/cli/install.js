 ...
 */
export function resolveInstallSpecs() {
 ...
 */
export function resolveTypeSpecs(cwd, { reactMajor = 19 } = {}) {
...
export function installCommand(packageManager, specs, { dev = false } = {}) {
 ...
 * failing silently.
 */
export function runInstall(cwd, packageManager, specs, { dev = false } = {}) {
