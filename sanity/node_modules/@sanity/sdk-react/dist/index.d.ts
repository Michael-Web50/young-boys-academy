...
import { ActionsResult, AgentGenerateOptions, AgentPatchOptions, AgentPatchResult, AgentPromptOptions, AgentPromptResult, AgentTransformOptions, AgentTranslateOptions, AuthState, ClientOptions, Comment, CommentThread, CommentsOptions, CreateCommentOptions, CurrentUser, DatasetHandle, DocumentAction, DocumentEvent, DocumentHandle as DocumentHandle$1, DocumentOptions, DocumentPermissionsResult, DocumentPresence, DocumentResource, DocumentTypeHandle as DocumentTypeHandle$1, FavoriteStatusResponse, FrameMessage, GetUserOptions, GetUsersOptions, JsonMatch, Organization, OrganizationOptions, Organizations, OrganizationsOptions, PresenceSelection, PreviewValue, Project, ProjectHandle, ProjectOptions, ProjectsOptions, QueryOptions, ReleaseAction, ReleaseDocument, RemoveCommentOptions, ReplyToCommentOptions, SanityConfig, SanityInstance, SanityUser, SetCommentStatusOptions, TokenSource, UpdateCommentOptions, UserPresence, WindowMessage } from "@sanity/sdk";
 ...
 */
declare const useSanityInstance: (
/**
 ...
 */
config?: SanityConfig) => SanityInstance;
/**
 * @public
 *
 ...
 * ```
 */
declare function useDispatchIntent(params: UseDispatchIntentParams): DispatchIntent;
 ...
 * @function
 */
declare const useOrganization: <IncludeMembers extends boolean = false, IncludeFeatures extends boolean = false>(options: OrganizationOptions<IncludeMembers, IncludeFeatures>) => Organization<IncludeMembers, IncludeFeatures>;
/**
 ...
 * @function
 */
declare const useOrganizations: <IncludeMembers extends boolean = false, IncludeFeatures extends boolean = false>(options?: OrganizationsOptions<IncludeMembers, IncludeFeatures>) => Organizations<IncludeMembers, IncludeFeatures>;
/**
 ...
 * @function
 */
declare const useProject: <IncludeMembers extends boolean = true, IncludeFeatures extends boolean = true>(options?: ProjectOptions<IncludeMembers, IncludeFeatures>) => Project<IncludeMembers, IncludeFeatures>;
/**
 * @public
 * @category Types
 * @interface
 ...
 */
type ProjectWithoutMembers = Project;
/**
 ...
 * @function
 */
declare const useProjects: <IncludeMembers extends boolean = false, IncludeFeatures extends boolean = true>(options?: ProjectsOptions<IncludeMembers, IncludeFeatures>) => Project<IncludeMembers, IncludeFeatures>[];
/**
 ...
 * ```
 */
declare function useActiveReleases(options?: WithResourceNameSupport<SanityConfig> | undefined): ReleaseDocument[];
/**
 * @public
 * @function
 *
 ...
 * ```
 */
declare function useAllReleases(options?: WithResourceNameSupport<SanityConfig> | undefined): ReleaseDocument[];
/**
 * @public
 */
