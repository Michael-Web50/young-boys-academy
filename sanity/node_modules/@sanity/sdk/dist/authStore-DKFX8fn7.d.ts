...
import { ClientConfig, ClientPerspective, ListenEvent, MultipleMutationResult, ReleaseDocument, ReleaseDocument as ReleaseDocument$1, ResponseQueryOptions, SanityClient, SanityDocument, SanityProject } from "@sanity/client";
...
/** @public */
declare const getDatasetsState: BoundStoreAction<FetcherStoreState<[options?: ProjectHandle<string> | undefined], import("@sanity/client").DatasetsResponse>, [options?: ProjectHandle<string> | undefined], StateSource<import("@sanity/client").DatasetsResponse | undefined>>;
/** @public */
declare const resolveDatasets: BoundStoreAction<FetcherStoreState<[options?: ProjectHandle<string> | undefined], import("@sanity/client").DatasetsResponse>, [options?: ProjectHandle<string> | undefined], Promise<import("@sanity/client").DatasetsResponse>>;
/**
...
export { ProjectOptions as $, unpublishDocument as $n, ApplicationInclude as $r, ApplyDocumentActionsOptions as $t, getUserState as A, DocumentAction as An, setCommentStatus as Ar, Organizations as At, getQueryKey as B, UnscheduleReleaseAction as Bn, ClientOptions as Br, InstallationActiveConfig as Bt, slicePath$1 as C, defineMutation as Ci, Action as Cn, RemoveCommentOptions as Cr, ResolveUserOptions as Ct, getCorsErrorProjectId as D, DeleteDocumentAction as Dn, createComment as Dr, UserProfile as Dt, isImportError as E, BoundStoreAction as Ei, CreateReleaseAction as En, UpdateCommentOptions as Er, SanityUserResponse as Et, getPerspectiveState as F, PublishReleaseAction as Fn, CommentReaction as Fr, OrganizationMember as Ft, projects as G, deleteRelease as Gn, handleAuthCallback as Gr, InstallationsResponse as Gt, parseQueryKey as H, createDocument as Hn, getClient as Hr, InstallationInclude as Ht, ReleaseState as I, ReleaseAction as In, CommentStatus as Ir, OrganizationOptions as It, Project as J, editRelease as Jn, AuthStateType as Jr, FavoriteStatusResponse as Jt, resolveProjection as K, discardDocument as Kn, observeOrganizationVerificationState as Kr, installation as Kt, getActiveReleasesState as L, ScheduleReleaseAction as Ln, CommentTextSelection as Lr, organization as Lt, loadMoreUsers as M, EditDocumentOptions as Mn, Comment as Mr, organizations as Mt, resolveUser as N, EditReleaseAction as Nn, CommentLocalState as Nr, Organization as Nt, FetcherStore as O, DeleteReleaseAction as On, removeComment as Or, UsersGroupState as Ot, resolveUsers as P, PublishDocumentAction as Pn, CommentMessage as Pr, OrganizationBase as Pt, ProjectMetadata as Q, unarchiveRelease as Qn, ApplicationDeployment as Qr, ActionsResult as Qt, getAllReleasesState as R, UnarchiveReleaseAction as Rn, CommentTextSelectionItem as Rr, Installation as Rt, jsonMatch$1 as S, defineFetcher as Si, JsonMatch as Sn, CreateCommentOptions as Sr, Membership as St, CORE_SDK_VERSION as T, StateSource as Ti, CreateDocumentAction as Tn, SetCommentStatusOptions as Tr, SanityUser as Tt, resolveQuery as U, createRelease as Un, getClientState as Ur, InstallationInterface as Ut, getQueryState as V, archiveRelease as Vn, ClientStoreState as Vr, InstallationBase as Vt, ProjectsOptions as W, deleteDocument as Wn, logout as Wr, InstallationsOptions as Wt, ProjectMember as X, publishRelease as Xn, ApplicationAccess as Xr, resolveFavoritesState as Xt, ProjectBase as Y, publishDocument as Yn, Application as Yr, getFavoritesState as Yt, ProjectMemberRole as Z, scheduleRelease as Zn, ApplicationBase as Zr, getReleaseDocumentId as Zt, SanityDocument$3 as _, Fetcher as _i, resolveDocument as _n, getCommentsOptionsKey as _r, StateEvent as _t, LoggedOutAuthState as a, ApplicationsResponse as ai, DocumentEditedEvent as an, LogContext as ar, getDocumentPresence as at, getPathDepth as b, MutationDefinition as bi, DocumentPermissionsResult as bn, resolveCommentThreads as br, GetUserOptions as bt, getCurrentUserState as c, UpdateApplicationInput as ci, DocumentRemotePatchesEvent as cn, Logger as cr, DisconnectEvent as ct, getLoginUrlState as d, deleteApplication as di, TransactionAcceptedEvent as dn, createDocumentHandle as dr, PresenceLocation as dt, ApplicationInterface as ei, applyDocumentActions as en, unscheduleRelease as er, project as et, getTokenState as f, updateApplication as fi, TransactionRevertedEvent as fn, createDocumentTypeHandle as fr, PresencePerspectiveOptions as ft, Role as g, CacheWriter as gi, getPermissionsState as gn, getCommentThreadsState as gr, RollCallEvent as gt, ReleaseDocument$1 as h, CacheTag as hi, getDocumentSyncStatus as hn, ResolveCommentsOptions as hr, ReportPresenceOptions as ht, LoggedInAuthState as i, ApplicationsOptions as ii, DocumentDiscardedEvent as in, InstanceContext as ir, ProjectionValuePending as it, getUsersState as j, EditDocumentAction as jn, updateComment as jr, OrganizationsOptions as jt, FetcherStoreState as k, DiscardDocumentAction as kn, replyToComment as kr, UsersStoreState as kt, getDashboardOrganizationId as l, application as li, DocumentTransactionSubmissionResult as ln, LoggerConfig as lr, DocumentPresence as lt, CurrentUser$1 as m, checkPermissions as mi, getDocumentState as mn, CommentsOptions as mr, PresenceSelectionPoint as mt, AuthStoreState as n, ApplicationVisibility as ni, DocumentCreatedEvent as nn, resolveDatasets as nr, PreviewQueryResult as nt, LoggingInAuthState as o, DeleteApplicationInput as oi, DocumentEvent as on, LogLevel as or, getPresence as ot, setAuthToken as p, AccessResourceType as pi, DocumentOptions as pn, createProjectHandle as pr, PresenceSelection as pt, getProjectionState as q, editDocument as qn, OrgVerificationResult as qr, installations as qt, ErrorAuthState as r, ApplicationWorkspace as ri, DocumentDeletedEvent as rn, configureLogging as rr, PreviewValue as rt, getAuthState as s, DeletedResult as si, DocumentPublishedEvent as sn, LogNamespace as sr, reportPresence as st, AuthState as t, ApplicationStudioConfig as ti, ActionErrorEvent as tn, getDatasetsState as tr, PreviewMedia as tt, getIsInDashboardState as u, applications as ui, DocumentUnpublishedEvent as un, createDatasetHandle as ur, DocumentPresenceOptions as ut, SanityProject$1 as v, FetcherDefinition as vi, resolvePermissions as vn, getCommentsState as vr, TransportEvent as vt, stringifyPath$1 as w, Selector as wi, ArchiveReleaseAction as wn, ReplyToCommentOptions as wr, ResolveUsersOptions as wt, joinPaths as x, MutationResult as xi, PermissionDeniedReason as xn, resolveComments as xr, GetUsersOptions as xt, getIndexForKey$1 as y, FetcherSnapshot as yi, subscribeDocumentEvents as yn, parseCommentsOptionsKey as yr, UserPresence as yt, QueryOptions as z, UnpublishDocumentAction as zn, CommentThread as zr, InstallationAccess as zt };
//# sourceMappingURL=authStore-DKFX8fn7.d.ts.map