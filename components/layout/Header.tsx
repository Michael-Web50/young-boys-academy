...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-brand-black/95 backdrop-blur-sm border-b border-brand-yellow/20">
        ...
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="flex-shrink-0 flex items-center gap-3">
            <Image
              ...
              priority
            />
            <h1 className="text-xl md:text-2xl font-bold text-brand-yellow tracking-tight hidden sm:block">
      ...
      {isOpen && (
        <div className="lg:hidden bg-brand-darkGray border-t border-brand-yellow/20">
