        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-brand-white/70 text-sm mb-4">
              Stay connected with our latest updates, match highlights, and academy news.
            </p>
            <div className="flex gap-3">
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/youngboys7980" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-brand-darkGray hover:bg-brand-yellow text-brand-white hover:text-brand-black rounded-full flex items-center justify-center transition-all duration-300"
              >
              ...
              {/* TikTok */}
              <a 
                href="https://www.tiktok.com/@youngboysfa" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-brand-darkGray hover:bg-brand-yellow text-brand-white hover:text-brand-black rounded-full flex items-center justify-center transition-all duration-300"
              >
              ...
              {/* Facebook */}
              <a 
                href="https://www.facebook.com/share/19NpCESTbw/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-brand-darkGray hover:bg-brand-yellow text-brand-white hover:text-brand-black rounded-full flex items-center justify-center transition-all duration-300"
              >
      ...
      <div className="border-t border-brand-white/10 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-brand-white/50 text-sm text-center md:text-left">
            &copy; {new Date().getFullYear()} Young Boys Football Academy. All rights reserved.
          </p>
